...
export const codicons : Record<string, number> = {
	add:									 0xea60,
	lightbulb:								 0xea61,
	repo:									 0xea62,
	fork:									 0xea63,
...
export function Icon(props: {code: number, color?: string}) {
	if (props.color)
		return <span class="codicon" style={`color:${props.color}`}>&#x{props.code.toString(16)};</span>;
